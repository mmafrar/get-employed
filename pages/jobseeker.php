...
<html>
	<head>
		<title>GetEmployed(); - Jobseeker</title>
		...
		<script type='text/javascript' src='../js/jobseeker_validation.js'></script>
	</head>
	<body>
		...
		<form name='register' method='post' action='' onSubmit='return validate()'>
			<center><h1>Register as a Jobseeker</h1></center>
			<tright>
			<img src="../img/seeker.png"><br>
            </tright>
			<table>
				<tr>
		...
		<?php
            if(isset($_POST["submit"])) {
                ...
                $sql = "INSERT INTO jobseeker(email, password, first_name, last_name, gender, dob, contact) VALUES ('$email', '$password', '$first_name', '$last_name', '$gender', '$dob', '$contact')";
